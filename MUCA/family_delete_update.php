...
if($name != $check_name || $mob_no != $check_mob_no){
    session_start();
    header('Location:cannot_update.php');
}
else if(($name == $check_name || $mob_no == $check_mob_no) && (mysqli_query($conn,$sql))){
...
<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">UPDATE FAMILY CARD DETAILS</button>

 
<div id="id01" class="modal">
<form class="modal-content animate" action="family_insert.php" method="POST">
      ...
      cellspacing="2">
          ...
          <tr>
              <td>Phone Number</td>
              <td><input type="number" name="mob_no" id="mob_no" size="30"></td>
          </tr>
          <tr>
          ...
          <tr>
              ...
              <td><input type="number" name="nof" id="nof" min="1"></td>
          </tr>
          <tr>
            <td>Family Members</td>
            <td><input type="text" name="fm"id="fm" size="30">
            </td>
        </tr>
